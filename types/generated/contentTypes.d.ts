...
export interface ApiAllergyAllergy extends Struct.CollectionTypeSchema {
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    type: Schema.Attribute.Enumeration<['allergen', 'normal']>;
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    profile_allergies: Schema.Attribute.Relation<
      ...
      'api::profile-allergy.profile-allergy'
    >;
    table_bookings: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProfileAllergyProfileAllergy
  extends Struct.CollectionTypeSchema {
...
export interface ApiTableBookingTableBooking
  ...
  attributes: {
    ...
    profile: Schema.Attribute.Relation<'manyToOne', 'api::profile.profile'>;
    people_count: Schema.Attribute.BigInteger;
